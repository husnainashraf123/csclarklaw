jQuery(document).ready(function() {
	...
	jQuery('#ithemes_backupbuddy_awstest').click(function(e) {
		...
		jQuery.post(jQuery(this).attr('alt'), { action: "aws_test", aws_accesskey: jQuery('#aws_accesskey').val(), aws_secretkey: jQuery('#aws_secretkey').val(), aws_bucket: jQuery('#aws_bucket').val(), aws_ssl: jQuery('#aws_ssl').val(), aws_directory: jQuery('#aws_directory').val() }, 
			function(data) {
